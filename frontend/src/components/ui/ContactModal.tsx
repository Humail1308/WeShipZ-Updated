              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                ...
                <form className="flex flex-col gap-4" onSubmit={handleFormSubmit}>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    {service === 'Other' && (
                      <textarea 
                        ...
                        disabled={isSubmitting}
                        className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 outline-none focus:border-electric-blue focus:bg-white transition-colors resize-none h-[100px] disabled:opacity-50"
                        required
                      />
                    )}
                  </div>
                  ...
                  <button 
                    type="submit" 
                    disabled={isSubmitting}
                    className="mt-4 bg-electric-blue hover:bg-blue-600 text-white font-bold py-4 rounded-xl transition-all shadow-[0_10px_20px_rgba(59,130,246,0.3)] hover:shadow-[0_15px_25px_rgba(59,130,246,0.4)] hover:-translate-y-1 disabled:opacity-70 disabled:hover:translate-y-0 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? 'Sending Code...' : 'Submit Details'}
                  </button>
                </form>
              </motion.div>
            )}
